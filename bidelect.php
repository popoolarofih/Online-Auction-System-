...
if (isset($_POST['go'])) {
   ...
   $insert = "insert into bidelect(Bid_id, Bid) values('$id', '$name')";
...
function getHighest($id){
   ...
   $sql = "select Bid from bidelect where Bid_id = '$id' order by Bid desc limit 1";
   $res = mysqli_query($conn, $sql);
...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>Bid product- Electronics</title>
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="titlepage">
                                 ...
                                 <div class=" col-md-12">
                                 <button class="send"><a href="./bidwinelect.php?id=<?php echo $id; ?>">Winner</a></button>
                                 </div> 
                           </div>
                        </div>
                     </div>

...
if (isset($_POST['go'])) {
  ...
  $insert = "insert into appliance(Name, Email, Phone, Product, Initial, Start, NameProduct, Frontv, Rearv, Rightv, Leftv, Enddate, Startdate) values('$name', '$email', '$number', '$describ', '$equip', '$start', '$adress','$img', '$rear', '$right', '$left', '$edate', '$sdate')";
...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>Upload product- Home Appliances</title>
      ...
      <div class="brand_color">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="titlepage">
                        <h2>Upload Home Appliances For Bidding</h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="contact">
        <div class="container">
            <div class="row">
                ...
                <form class="main_form" method="POST" action="applaince.php" enctype="multipart/form-data">
                        <div class="row">

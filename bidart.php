...
if(isset($_GET['id'])){
   ...
   $sql = "select * from artifact where id = '$id'";
...
if (isset($_POST['go'])) {
   ...
   $insert = "insert into bidart(Bid_id, Bid) values('$id', '$name')";
...
function getHighest($id){
   ...
   $sql = "select Bid from bidart where Bid_id = '$id' order by Bid desc limit 1";
   $res = mysqli_query($conn, $sql);
...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>Bid product- Artifact</title>
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="titlepage">
                                 ...
                                 <div class=" col-md-12">
                                 <button class="send"><a href="./bidwinart.php?id=<?php echo $id; ?>">Winner</a></button>
                                 </div> 
                           </div>
                        </div>
                     </div>
                     <h3>Name: <?php echo $name; ?></h3>
                     <h3>Category:<span>Home Appliances</span></h3>
                     <h3>Start: <?php echo $start; ?></h3>
                     <h3>Until: <?php echo $until; ?></h3>
                     <h3>Starting Amount:# <?php echo $start; ?></h3>
                     <h3>Highest Bid:# <?php echo  $highest; ?></h3>
                     <?php
$conn = mysqli_connect("localhost", "root", "", "auction") or die ("Error : " . mysqli_error($conn));
$select = "select * from bidelart";

            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="title">
                     ...
                     <span>Bid the different varieties of Cars here.</span>
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="imgg">
               ...
               <span>Right View</span>
                ...
                <?php echo '<span> Product Owner:<h3>'.$full.' </h3></span> '; ?>
					...
					<a href="./bidcar.php?id=<?php echo $row['Id'];?>"><button onclick="add_taskk()" class="btn btn-secondary text-white py-3 px-4">Bid</button></a>

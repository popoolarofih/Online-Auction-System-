...
if (isset($_POST['go'])) {
  ...
  $insert = "insert into land(Name, Email, Phone, Product, Initial, Start, NameProduct, Frontv, Rearv, Rightv, Leftv, Enddate, Startdate) values('$name', '$email', '$number', '$describ', '$equip', '$start', '$adress','$img', '$rear', '$right', '$left', '$edate', '$sdate')";
...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>Upload product- Electronics</title>
      ...
      <div class="brand_color">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="titlepage">
                        <h2>Upload Electronics For Bidding</h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="contact">
        <div class="container">
            <div class="row">
                ...
                <form class="main_form" method="POST" action="land.php" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                            
                                <input autocomplete="off" class="form-control" placeholder="Your name" type="text" name="name" required/>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                <input autocomplete="off"  class="form-control" placeholder="Email" type="email" name="email" required/>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                <input autocomplete="off"  class="form-control" placeholder="Phone" type="tel" name="phone" required/>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                <input autocomplete="off"  class="form-control" placeholder="Name Of Product" type="text" name="nameproduct" required/>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                <input autocomplete="off"  class="form-control" placeholder="Starting Price" type="number" name="start" required/>
                               
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                <input autocomplete="off"  class="form-control" placeholder="Initial Price" type="number" name="initial" required/>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                <input autocomplete="off"  class="form-control" placeholder="Starting Date" type="datetime-local" name="date" required/>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                <input autocomplete="off"  class="form-control" placeholder="Ending Date"  type="datetime-local" name="end" required/>
                            </div>

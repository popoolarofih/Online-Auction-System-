...
if (isset($_POST['go'])) {
   ...
   $insert = "insert into bidcar(Bid_id, Bid) values('$id', '$name')";
...
function getHighest($id){
   ...
   $sql = "select Bid from bidcar where Bid_id = '$id' order by Bid desc limit 1";
   $res = mysqli_query($conn, $sql);
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="titlepage">
                                 ...
                                 <div class=" col-md-12">
                                 <button class="send"><a href="./bidwincar.php?id=<?php echo $id; ?>">Winner</a></button>
                                 </div> 
                           </div>
                        </div>
                     </div>

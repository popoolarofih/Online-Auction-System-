...
<main class="form-signin">
    ...
    <h1 class="h3 mb-3 fw-normal">Welcome To Polla's Admin</h1>
    <h1 class="h3 mb-3 fw-normal">Please sign Up as an Admin</h1>
    ...
    <span>already have an account?</span><a href="adminin.php">Sign-In</a>

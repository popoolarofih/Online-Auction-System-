       ...
       <div class="brand_color">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="titlepage">
                        <h2>Bidding Item - Home Appliances</h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="title">
                     ...
                     <span>Bid the different varieties of Home Appliances here.</span>
                  </div>
               </div>
            </div>
         </div>
              ...
              <div class="title" >
               ...
               <span>Right View</span>
                ...
                <?php echo '<span> Product Owner:<h3>'.$full.' </h3></span> '; ?>
					...
					<a href="./bidapp.php?id=<?php echo $row['Id'];?>"><button onclick="add_taskk()" class="btn btn-secondary text-white py-3 px-4">Bid</button></a>
            </div>
...
?>
      ...
      <script>
         ...
         let add_container = document.querySelector(".brand_color");
